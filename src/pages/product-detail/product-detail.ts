...
export class ProductDetailPage {
  ...
  addToCartProduct() {
    ...
    if (this.product.type == 'grouped') {
      ...
      if (total == 0) this.translateService.get("Please Add Quantity").subscribe((res) => { this.alert.show(res); });
      else
  ...
  quantityChange() {
    ...
    if (this.product.stock_quantity == null) { console.log("quantity is unlimited"); }
      ...
      this.translateService.get("Product Quantity is Limited!").subscribe((res) => {
