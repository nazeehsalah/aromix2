...
export class ProductsPage {
  ...
  getFilterdProducts() {
    ...
    this.http
      ...
      .map(res => res.json())
      .subscribe(data => {
        if (data.data) this.listOfFilteredIdsFromCustom = data.data;
        this.applicationRef.tick();
  ...
  getFilterdProductsFromWoo() {
    ...
    console.log(q);
    this.config.Woocommerce.getAsync(
      q + "&" + this.config.productsArguments
    ).then(dat => {
      //this.loading.hide();
  ...
  openSortBy() {
    var buttonArray = [];
    this.translateService.get(this.sortArray).subscribe(res => {
      // console.log(res);
      ...
      this.translateService.get("Cancel").subscribe(res => {
        buttonArray.push({
          text: res,
          role: "cancel",
          handler: () => {
  ...
  getAllAttributes() {
    ...
    this.http
      .get(
        this.config.url +
          "/api/appsettings/ionic_get_attributes/?insecure=cool" /* +
          query */
      )
      .map(res => res.json())
      .subscribe(data => {
  ...
  toggleMenu() {
    ...
    if (this.config.appDirection == "ltr") this.menuCtrl.toggle("right");
    else this.menuCtrl.toggle("left");
  }
  //=======================================================================================
